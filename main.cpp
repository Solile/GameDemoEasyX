...
IMAGE image_menu_background;					// 主菜单背景图片
...
IMAGE img_gravestone_left;						// 向左朝向墓碑图片
IMAGE img_gravestone_right;						// 向右朝向墓碑图片
...
IMAGE img_P1_cursor;							// 1P 指示光标图片
IMAGE img_P2_cursor;							// 2P 指示光标图片

Atlas atlas_peashooter_idle_left;				// 豌豆射手向左朝向的默认动画图集
Atlas atlas_peashooter_idle_right;				// 豌豆射手向右朝向的默认动画图集
Atlas atlas_peashooter_run_left;				// 豌豆射手向左朝向的奔跑动画图集
Atlas atlas_peashooter_run_right;				// 豌豆射手向右朝向的奔跑动画图集
Atlas atlas_peashooter_attack_ex_left;			// 豌豆射手向左朝向的特殊攻击动画图集
Atlas atlas_peashooter_attack_ex_right;			// 豌豆射手向右朝向的特殊攻击动画图集
Atlas atlas_peashooter_die_left;				// 豌豆射手向左朝向的死亡动画图集
Atlas atlas_peashooter_die_right;				// 豌豆射手向右朝向的死亡动画图集

Atlas atlas_sunflower_idle_left;				// 向日葵向左朝向的默认动画图集
Atlas atlas_sunflower_idle_right;				// 向日葵向右朝向的默认动画图集
Atlas atlas_sunflower_run_left;					// 向日葵向左朝向的奔跑动画图集
Atlas atlas_sunflower_run_right;				// 向日葵向右朝向的奔跑动画图集
Atlas atlas_sunflower_attack_ex_left;			// 向日葵向左朝向的特殊攻击动画图集
Atlas atlas_sunflower_attack_ex_right;			// 向日葵向右朝向的特殊攻击动画图集
Atlas atlas_sunflower_die_left;					// 向日葵向左朝向的死亡动画图集
Atlas atlas_sunflower_die_right;				// 向日葵向右朝向的死亡动画图集
...
{
	AddFontResourceEx(_T("resources/IPix.tff"), FR_PRIVATE, NULL);	// 字体资源

	loadimage(&image_menu_background, _T("resources/menu_background.png"));
	...
	loadimage(&img_P1_cursor, _T("resources/1P_cursor.png"));
	loadimage(&img_P2_cursor, _T("resources/2P_cursor.png"));
