...
public:
	...
	void on_enter()
	{
		...
		timer_winner_slide_in.set_one_shoot(true);
		...
		timer_winner_slide_out.set_one_shoot(true);
	...
	void on_update(int delta)
	{
		...
		const Vector2D& position_player1 = player_1->get_position();
		const Vector2D& position_player2 = player_2->get_position();
