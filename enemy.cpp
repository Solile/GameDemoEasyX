...
Enemy::Enemy()
{
	...
	{
		{
			...
			animation_aim_left.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
			animation_aim_left.add_frame(ResourcesManager::instance()->find_altas("enemy_aim_left"));
			...
			animation_aim_right.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
			animation_aim_right.add_frame(ResourcesManager::instance()->find_altas("enemy_aim_right"));
		}
		{
			...
			animation_dash_in_air_left.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
			animation_dash_in_air_left.add_frame(ResourcesManager::instance()->find_altas("enemy_dash_in_air_left"));
			...
			animation_dash_in_air_right.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
			animation_dash_in_air_right.add_frame(ResourcesManager::instance()->find_altas("enemy_dash_in_air_right"));
		}
		{
			...
			animation_dash_on_floor_left.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
			animation_dash_on_floor_left.add_frame(ResourcesManager::instance()->find_altas("enemy_dash_on_floor_left"));
			...
			animation_dash_on_floor_right.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
			animation_dash_on_floor_right.add_frame(ResourcesManager::instance()->find_altas("enemy_dash_on_floor_right"));
		}
		{
			...
			animation_fall_left.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
			animation_fall_left.add_frame(ResourcesManager::instance()->find_altas("enemy_fall_left"));
			...
			animation_fall_right.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
			animation_fall_right.add_frame(ResourcesManager::instance()->find_altas("enemy_fall_right"));
		}
		{
			...
			animation_idle_left.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
			animation_idle_left.add_frame(ResourcesManager::instance()->find_altas("enemy_idle_left"));
			...
			animation_idle_right.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
			animation_idle_right.add_frame(ResourcesManager::instance()->find_altas("enemy_idle_right"));
		}
		{
			...
			animation_jump_left.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
			animation_jump_left.add_frame(ResourcesManager::instance()->find_altas("enemy_jump_left"));
			...
			animation_jump_right.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
			animation_jump_right.add_frame(ResourcesManager::instance()->find_altas("enemy_jump_right"));
		}
		{
			...
			animation_run_left.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
			animation_run_left.add_frame(ResourcesManager::instance()->find_altas("enemy_run_left"));

			Animation& animation_run_right = animation_run.right;
			animation_run_right.set_interval(0.05f);
			animation_run_right.set_loop(true);
			animation_run_right.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
			animation_run_right.add_frame(ResourcesManager::instance()->find_altas("enemy_run_right"));
		}
		{
			...
			animation_squat_left.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
			animation_squat_left.add_frame(ResourcesManager::instance()->find_altas("enemy_squat_left"));
			...
			animation_squat_right.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
			animation_squat_right.add_frame(ResourcesManager::instance()->find_altas("enemy_squat_right"));
		}
		{
			...
			animation_throw_barb_left.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
			animation_throw_barb_left.add_frame(ResourcesManager::instance()->find_altas("enemy_throw_barb_left"));
			...
			animation_throw_barb_right.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
			animation_throw_barb_right.add_frame(ResourcesManager::instance()->find_altas("enemy_throw_barb_right"));
		}
		{
			...
			animation_throw_silk_left.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
			animation_throw_silk_left.add_frame(ResourcesManager::instance()->find_altas("enemy_throw_silk_left"));
			...
			animation_throw_silk_right.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
			animation_throw_silk_right.add_frame(ResourcesManager::instance()->find_altas("enemy_throw_silk_right"));
		}
		{
			...
			animation_throw_sword_left.set_interval(0.1f);
			animation_throw_sword_left.set_loop(true);
			animation_throw_sword_left.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
			animation_throw_sword_left.add_frame(ResourcesManager::instance()->find_altas("enemy_throw_sword_left"));

			Animation& animation_throw_sword_right = animation_throw_sword.right;
			animation_throw_sword_right.set_interval(0.1f);
			animation_throw_sword_right.set_loop(true);
			animation_throw_sword_right.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
			animation_throw_sword_right.add_frame(ResourcesManager::instance()->find_altas("enemy_throw_sword_right"));
		}
	}

	{
		...
		animation_silk.add_frame(ResourcesManager::instance()->find_altas("silk"));
		...
		animation_dash_in_air_left.add_frame(ResourcesManager::instance()->find_altas("enemy_vfx_dash_in_air_left"));
		...
		animation_dash_in_air_right.add_frame(ResourcesManager::instance()->find_altas("enemy_vfx_dash_in_air_right"));
		...
		animation_dash_on_floor_left.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
		animation_dash_on_floor_left.add_frame(ResourcesManager::instance()->find_altas("enemy_vfx_dash_on_floor_left"));
		...
		animation_dash_on_floor_right.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
		animation_dash_on_floor_right.add_frame(ResourcesManager::instance()->find_altas("enemy_vfx_dash_on_floor_right"));
	}
	{
