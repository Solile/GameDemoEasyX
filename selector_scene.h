...
public:
	...
	void on_draw(const Camera& camera)
	{
		...
		putimage_alpha(getwidth() - img_p2_selector_background->getwidth(), 0,
			img_p2_selector_background->getwidth() - selector_background_scorll_offset_x, 0, img_p2_selector_background, 
			selector_background_scorll_offset_x, 0);
...
private:
	...
	int selector_background_scorll_offset_x = 0;	// ±≥æ∞πˆ∂Øæ‡¿Î
