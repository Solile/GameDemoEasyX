...
Player::Player()
{
	...
	timer_roll_cd.set_one_shoot(true);
	...
	{
		{
			...
			animation_attack_left.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
			...
			animation_attack_right.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
		...
		}
		{
			...
			animation_dead_left.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
			...
			animation_dead_right.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
		...
		}
		{
			...
			animation_roll_left.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
			...
			animation_roll_right.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
...

	{
		...
		animation_jump_vfx.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
		...
		animation_land_vfx.set_anchor_mode(Animation::AnchorMode::BottomCenterd);
